            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        @if ($isServerSide)
                        <div class="search-form-clientes">
                        <form method="get" class="form-search" action="{{action('ParticipationController@index')}}">
                            <div id="search-input">                  
                                <input type="hidden" value="contains" name="filter" />
                                <input type="hidden" value="sannyas" name="key" />
                                
                                <div class="input-group col-md-12">
                                    <input type="text" class="form-control" placeholder="Procurar Sannyas" name="s" value="{{ empty($search) ? '' : $search->value }}">
